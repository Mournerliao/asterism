...
- **当前产品 frontier 为 Phase 2.2**：ADR 0033 已接受 Collection Dial 原型方向，buildable spec 为 GitHub #29；5 张 blockers-first tickets 已按原生依赖 #30 → #31 → #32 → #33 → #34 发布，#30–#32 已实现，当前 frontier 为 #33 More / New / Undo / durable recovery。Phase 3 浏览器扩展仍可独立开始，不受该 Web 增强阻塞。
...
| Phase 2.2 | Collection Dial | 实现中（#30–#32 Done；当前 #33） |
