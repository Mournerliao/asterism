...
- [x] **Collection Dial More / New / Undo / durable recovery（2026-08-14，GitHub #33）**：More / New 已承接 frozen catalog 与 scope；新集合创建和关系 add 分离恢复；operation-scoped 30 秒 Undo、receipt/head 冲突保护、响应丢失幂等与 Browse ledger 恢复已实现。下一 ticket 为 #34 连续桌面 / 移动真实任务验收与 throwaway prototype 退役；#33 migration / Edge Function 尚未部署，本机 pgTAP 因数据库未运行未执行。见 `logs/2026-08-14-issue-33-more-new-undo-recovery.md`。
